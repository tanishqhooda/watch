...
public class NewJFrame extends javax.swing.JFrame {
    ...
    int value;    
String IDa=J1.getText();
String name=J2.getText();
String stylea=J3.getText();
...
Amn.counter=String.valueOf(Amn.count);
    ...
    try
    {
        ...
        Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/ww","root","root");
        Statement stmt=(Statement)con.createStatement();
        //To get current value of no. from database
         String query2="SELECT NO FROM watch ORDER BY no DESC LIMIT 1";
        ...
        String query="INSERT INTO WATCH VALUES('"+IDa+"','"+name+"','"+stylea+"','"+cost+"','"+value+"');";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/ww","root","root");
        Statement stmt=(Statement)con.createStatement();
        String query="SELECT STYLE,COST,WATCHNAME FROM WATCH WHERE ID='"+IDa+"';";
        ResultSet rs=stmt.executeQuery(query);
        if (rs.next())
                {
             String cost = rs.getString("COST");
             String stylea  = rs.getString("STYLE");
              ...
              catch (Exception e)
{
    ...
    try
    {
        ...
        Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/ww","root","root");
        Statement stmt=(Statement)con.createStatement();
        String query=" UPDATE WATCH SET WATCHNAME='"+name+"',style='"+stylea+"',cost='"+cost+"' WHERE ID='"+IDa+"';";
        stmt.executeUpdate(query);
    ...
    try
    {
        ...
        System.out.println(counter);
         ...
         value--;
         counter=Integer.toString(value);
        String query="DELETE FROM WATCH WHERE ID='"+IDa+"';";
        stmt.executeUpdate(query);
...
String numberr;
        ...
        Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/ww","root","root");
        Statement stmt=(Statement)con.createStatement();
        String findnumber="SELECT NO from watch WHERE ID='"+IDa+"';";
        ResultSet rs1=stmt.executeQuery(findnumber);
        
        if (rs1.next())
        {
             numberr=rs1.getString("No");
              String query="SELECT * FROM WATCH WHERE NO>'"+numberr+"'ORDER BY NO  LIMIT 1;";
              
        ResultSet rs=stmt.executeQuery(query);
        if (rs.next())
                {
             String cost1 = rs.getString("COST");
             String stylea1  = rs.getString("STYLE");
...
String numberr;
        ...
        {
             numberr=rs1.getString("No");
              String query="SELECT * FROM WATCH WHERE NO <'"+numberr+"'ORDER BY NO DESC LIMIT 1;";
              ...
              catch (Exception e)
{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/ww","root","root");
        Statement stmt=(Statement)con.createStatement();
        String query="SELECT * FROM WATCH WHERE NO='"+cc+"';";
        ResultSet rs=stmt.executeQuery(query);
        if (rs.next())
                {
             String ida=rs.getString("ID");
             String cost = rs.getString("COST");
             String stylea  = rs.getString("STYLE");
             String Name=rs.getString("watchname");
             J1.setText(ida);
              ...
              catch (Exception e)
{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        String query="SELECT * FROM WATCH ORDER BY NO  LIMIT 1;";
              ...
              catch (Exception e)
{
    ...
    public static void main(String args[]) {
        ...
        Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/ww","root","root");
        Statement stmt=(Statement)con.createStatement();
        String query="SELECT NO FROM watch ORDER BY no DESC LIMIT 1";
        ResultSet rs=stmt.executeQuery(query);
        if (rs.next())
                {
